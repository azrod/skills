...
- **Directory name must match `name` field**: If `name: pdf-processor` is in frontmatter but the directory is named `pdf-tool`, validation will fail. Always rename the directory or update the `name` field to match.
